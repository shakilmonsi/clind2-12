...
const DetalCard = ({ data }) => {
  ...
  return (
    <div className="p-5 m-5 mx-auto max-w-2xl overflow-hidden bg-pink-200 rounded-lg shadow-md dark:bg-gray-800">
      ...
      <div className="p-6">
        <div>
          ...
          <p className="mt-2 text-sm text-yellow font-bold">
          ...
          <label
            ...
            className="btn btn-sm btn-outline btn-success mt-5 text-pink-900 font-bold block px-5 mx-auto"
          >
            ORDER Now
          </label>
        </div>
